 ...
 */
public class PhongBitmapMapMaterial extends MaterialBase
{
    ...
    public function PhongBitmapMapMaterial(texture:BitmapData, normalMap:BitmapData, specularMap:BitmapData)
    {
        super();
