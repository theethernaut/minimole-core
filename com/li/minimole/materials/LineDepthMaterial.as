 ...
 */
public class LineDepthMaterial extends MaterialBase implements IColorMaterial
{
    ...
    public function LineDepthMaterial(color:uint = 0xFFFFFF, thickness:Number = 0.02)
    {
        super();
